      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-primary-foreground/70 max-w-lg mx-auto text-[15px]">
            Share your engineering challenge. We respond within 4 hours with a preliminary assessment.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <button className="group inline-flex items-center gap-3 px-7 py-3 bg-primary text-primary-foreground text-sm font-semibold rounded hover:bg-accent-orange-2 hover:shadow-[0_8px_24px_hsl(0_78%_48%/0.35)] transition-all">
