      ...
      <section className="relative z-[1] py-24 px-8 md:px-16 bg-accent text-primary-foreground">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-8 h-0.5 bg-primary" />
              <span className="font-mono text-[11px] font-medium tracking-[0.2em] uppercase text-primary">Results</span>
              <div className="w-8 h-0.5 bg-primary" />
            </div>
            <h2 className="font-display text-3xl md:text-4xl font-extrabold text-primary-foreground mb-4">
              ACHIEVEMENTS & REAL-WORLD EXECUTION
            </h2>
            <p className="text-primary-foreground/70 max-w-xl mx-auto text-[15px]">
              We let our results speak for us. Explore our delivered actual projects and hear directly from partners.
            </p>
          </motion.div>

          <motion.div {...fadeUp}>
            <div className="aspect-[21/9] rounded-xl border-2 border-dashed border-primary-foreground/20 bg-accent/60 flex flex-col items-center justify-center gap-4">
              <ImageIcon className="w-12 h-12 text-primary-foreground/30" />
              <p className="font-mono text-[11px] tracking-[0.15em] uppercase text-primary-foreground/50">
                Project Gallery & Testimonials — Coming Soon
              </p>
              <p className="text-primary-foreground/40 text-xs max-w-md text-center">
                Dynamic grid of actual delivered projects with client testimonials
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative z-[1] py-20 px-8 md:px-16">
        <motion.div {...fadeUp} className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-silver text-[15px] mb-8">
            Submit your specifications or initiate a project conversation directly.
          </p>
