...
const videos = [
  {
    ...
    label: "Manufacturing",
    description:
      "A close-up look at our state-of-the-art Vertical Machining Centres (VMC) in action. Watch as high-precision mould cavities are machined from raw steel blocks to micron-level tolerances — a process that defines the quality of every tool we deliver.",
  ...
  },
  {
    ...
    description:
      "Our in-house trial press bay allows us to validate every mould before shipment. This footage captures a full trial run — from mould mounting and clamping to the first shot of plastic, dimensional inspection, and process parameter setting. Zero surprises at the customer's facility.",
  ...
  },
  {
    ...
    label: "Assembly",
    description:
      "From precision-machined halves to a fully assembled, inspected, and finished tool — this video walks through our end-to-end mould assembly process. Every slide, lifter, cooling circuit, and ejector pin is fitted and verified against the design specification before dispatch.",
